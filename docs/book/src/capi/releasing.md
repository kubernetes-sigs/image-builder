...
- Create a new tag:
  - `export IB_VERSION=v0.1.x`
    - *Replace `x` with the next patch version. For example: `v0.1.28`.*
...
```
Image-builder v0.1.28 is now available: https://github.com/kubernetes-sigs/image-builder/releases/tag/v0.1.27
