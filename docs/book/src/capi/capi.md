...
```sh
PACKER_VAR_FILES=extra_vars.json make build-ova-local-photon-3
```
...
```sh
PACKER_VAR_FILES=internal_repos.json make build-ova-local-photon-3
```
...
```sh
PACKER_VAR_FILES=proxy.json make build-ova-local-photon-3
```
